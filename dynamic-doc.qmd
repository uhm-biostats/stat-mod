...
![An image from Kawika et al. 2018](img/data-intro/wao.png){width="50%" fig-align="left"}
...
![Remember this old map?](https://uhm-biostats.github.io/stat-mod/datasets-intro_files/figure-html/fig-map-1.png){width="75%" fig-align="left"}
...
image_read_pdf("kable_example.pdf") |> 
...
That's right! We can make figures with code and have them displayed in our rendered documents. 
