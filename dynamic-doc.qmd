...
format:
  html:
    code-links:
      - text: View source
        icon: github
        href: https://github.com/uhm-biostats/stat-mod/blob/main/dynamic-doc.qmd
...
As already mentioned, quarto has [extensive documentation online](https://quarto.org/docs/guide/).
