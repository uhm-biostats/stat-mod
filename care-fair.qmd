...
format:
  html:
    code-links:
      - text: View source
        icon: github
        href: https://github.com/uhm-biostats/stat-mod/blob/main/care-fair.qmd
---
...
- Interoperable: metadata (see tables in the [previous chapter](datasets-intro.qmd)) clearly define all data fields allowing data to be merged or integrated into other workflows
...
```{=html}
<iframe class="slide-deck" src="care-fair-slides.html"></iframe>
```
