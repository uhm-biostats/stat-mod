...
The Open to Collaborate Notice is an *Engagement Notice* that can be used to indicate a researcher's or institution's commitment to CARE principles and working collaboratively on issues of IDSov and IDGov. Engagement Notices are not applied to data, but rather are appropriate to display on, for example, research or institution websites. See full information [here](https://localcontexts.org/notice/open-to-collaborate/).
...
Another article centering CARE practices in a closely related journal, including overlapping authors, using data from within the same [mokupuni](https://wehe.hilo.hawaii.edu/?q=mokupuni#w2w2-33939) of Hawaiʻi, is not able to display Local Contexts Notices on equal footing with FAIR-related badges. Instead, Notices are displayed in data figures (the best solution available). But if Labels were to replace these Notices, the static figure would not reflect that update, whereas dynamic badges rendered by the journal itself would be able to.
...
The work of advancing IDSov and IDGov in Hawaiʻi is rooted in correcting and healing the violence against and violations of human rights and Indigenous rights perpetrated against the Kanaka[^1] ʻŌiwi by European and American colonizers from first European contact, through the US-backed illegal overthrow, through illegal US annexation, to the present. The research apparatus, including the University of Hawaiʻi, and scientific racism were and remain integral parts of Euro-American colonization [@allkine]. Therefore research and scientific work in Hawaiʻi holds a distinct [kuleana](https://wehe.hilo.hawaii.edu/?q=kuleana#w2w2-12545) to confront and correct continued colonial practices and [kākoʻo](https://wehe.hilo.hawaii.edu/?q=kakoo#w2w2-11650) the Kanaka ʻŌiwi right to [ea](https://wehe.hilo.hawaii.edu/?q=ea#w2w2-4043) and self-determination.

[^1]: We follow @kauanui2008 in using the plural Kānaka ʻŌiwi to refer to Native Hawaiians and the singular Kanaka ʻŌiwi to refer to the singular collective Native Hawaiian People.

## CARE and FAIR for this class

we use data that we cannot change the metadata of

we therefore only use the open to collab

the data and meta data are FAIR
