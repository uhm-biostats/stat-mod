...
![](img/github_how2/fig_git_project.png){width="75%"}
...
![](img/github_how2/fig_commit.png){width="75%"}
...
![](img/github_how2/fig_push.png){width="75%"}
...
![](img/github_how2/watch-github.png){width="75%"}
...
### Working collaboratively: branches and pull requests
...
![](img/github_how2/git-fail-behind.png){width="75%"}
...
![](img/github_how2/merge-conflict.png){width="75%"}
...
![](img/github_how2/new-branch.png){width="50%"}
...
![](img/github_how2/switch-branch.png)
...
![](img/github_how2/start-pr-1.png)
...
![](img/github_how2/start-pr-2.png)
...
You will have your own notes assignments repo created for you in our shared GitHub organization: [zool631-spr-2026](https://github.com/zool631-spr-2026). Go through the steps of integrating that repo with RStudio.
...
For each lab, you will have a lab report repo created for you and a group of team members in our shared GitHub organization: [zool631-spr-2026](https://github.com/zool631-spr-2026). 
